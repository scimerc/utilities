...
# Given a matrix `data`, where rows are observations and columns are individual dimensions, compute the gap statistic (according to a uniform reference distribution).
gap_statistic = function(data, min_num_clusters = 1, max_num_clusters = 12, num_reference_bootstraps = 100) {
